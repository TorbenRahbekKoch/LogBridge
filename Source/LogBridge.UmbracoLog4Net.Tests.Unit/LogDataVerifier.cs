...
namespace SoftwarePassion.LogBridge.UmbracoLog4Net.Tests.Unit
{
    public class LogDataVerifier : ILogDataVerifier
    {
        ...
        public void VerifyLogData(LogData expected)
        {
            ...
            actual.Properties[LogConstants.EventIdKey].Should().Be(expected.EventId, because: "EventId should match");
